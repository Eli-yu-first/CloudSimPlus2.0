...
import org.cloudsimplus.examples.dynamic.RandomCloudletsArrivalExample;
 ...
 */
public class RandomCloudletsArrivalExampletest {
    /**
    ...
    private static final int VM_NUM = 10;
...
//    private final Datacenter datacenter0;
    ...
    static final Random randomR = new Random();
    private static final double Vm_mips =  1000.0;
    public static void main(String[] args) {
        new RandomCloudletsArrivalExampletest();
    }

    private RandomCloudletsArrivalExampletest() {
    ...
    private Vm createVm(final int pes) {
        final double mips = randomR.nextInt(170)*1.0 + 1000.0;
        long size = 10000; // image size (Megabyte)
        int ram = 512; // vm memory (Megabyte)
        long bw = 1000;

        return new VmSimple(Vm_mips, pes)
...
//    }
    ...
    private Cloudlet createCloudlet() {
        ...
        final long length = randomR.nextInt(5000) + 8000; // in number of Million Instructions (MI)
        int pesNumber = 2;

        UtilizationModel um = new UtilizationModelDynamic(0.2);
        Cloudlet cloudlet  =  new CloudletSimple(10000, pesNumber)
